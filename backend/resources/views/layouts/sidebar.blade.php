<div class="fixed" style="top: 0; bottom: 0; left: 0; padding-top: 50px; width: 13rem; overflow: hidden;">
    ...
    <div class="overflow-y-auto bg-nav min-h-screen">
        <ul class="p-0">
            ...
            <li>
                ...
                <div class="collapse" id="collapseExample">
                    <ul class="p-0">
                        ...
                        <li>
                            <a class="flex items-center py-3 hover:bg-theme {{ Request::is('withdraw-request') ? 'active' : '' }}" href="{{route('organiser.withdraw-request.index')}}" style="padding-left: 2rem;">Rút
                                tiền</a>
                        </li>
                    </ul>
                </div>
            ...
            <li>
                <a href="{{ route('organiser.transaction.index') }}" class="flex items-center p-3 hover:bg-theme {{ Request::is('transaction') ? 'active' : '' }}">
